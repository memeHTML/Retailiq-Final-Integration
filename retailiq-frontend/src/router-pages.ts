...
export const MarketIntelligencePage = lazy(() => import('@/features/analytics/MarketIntelligencePage'));
...
export const SmartAlertsPage = lazy(() => import('@/pages/SmartAlerts'));
export const ReportsPage = lazy(() => import('@/pages/Reports'));
export const FinancialCalendarPage = lazy(() => import('@/pages/FinancialCalendar'));
...
export const StaffPerformancePage = lazy(() => import('@/features/analytics/StaffPerformancePage'));
...
export const DecisionsPage = lazy(() => import('@/features/ai/DecisionsPage'));
