...
describe('finance workflow verification', () => {
  ...
  it('renders the finance hub and shortcuts', () => {
    ...
    expect(screen.getByText('E-Invoicing')).toBeTruthy();
    expect(screen.getByRole('link', { name: 'Open GST & Tax' }).getAttribute('href')).toBe('/finance/gst');
    expect(screen.getByRole('link', { name: 'Open E-Invoicing' }).getAttribute('href')).toBe('/finance/einvoice');
    expect(screen.getByRole('button', { name: 'overview' })).toBeTruthy();
    expect(screen.getByRole('button', { name: 'kyc' })).toBeTruthy();
