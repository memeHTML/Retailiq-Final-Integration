...
import { useDismissInventoryAlertMutation, useInventoryAlertsQuery } from '@/hooks/useInventory';
...
export default function AlertsPage() {
  ...
  const unifiedAlerts = useMemo<UnifiedAlert[]>(() => {
    const dashboardAlerts: UnifiedAlert[] = (dashboardAlertsQuery.data?.alerts ?? []).map((alert: { id: string | number; severity: 'high' | 'medium' | 'low'; title: string; message: string; timestamp: string; source?: string }) => ({
