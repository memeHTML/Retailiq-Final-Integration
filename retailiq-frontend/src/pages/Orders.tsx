          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="button-row">
                <Link className="button" to={routes.ordersPos}>Open POS</Link>
                <Link className="button button--secondary" to={routes.ordersTransactions}>View Transactions</Link>
              </div>
            </CardContent>
          </Card>
          <Card>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="button-row">
                <Link className="button" to={routes.purchaseOrders}>Open Purchase Orders</Link>
              </div>
            </CardContent>
          </Card>
          <Card>
