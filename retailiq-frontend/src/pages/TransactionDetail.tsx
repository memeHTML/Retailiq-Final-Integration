...
export default function TransactionDetailPage() {
  ...
  const query = useTransactionQuery(uuid ?? '');
  ...
  if (!query.data) {
    return <EmptyState title="Transaction not found" body="The requested transaction is unavailable." action={{ label: 'Back to transactions', onClick: () => navigate('/orders/transactions') }} />;
  }
    ...
    <PageFrame
      ...
      actions={(
        <div className="button-row">
          <button className="button button--secondary" type="button" onClick={() => navigate('/orders/transactions')}>
            Back
          </button>
          {canReturn ? (
