      ...
      signals: [
        {
          ...
          market_price: 128,
          price_difference: 8,
          price_difference_percent: 6.7,
          trend: 'UP',
          confidence: 0.87,
          signal_date: '2026-03-27T09:00:00Z',
          region: 'North',
          competitor_prices: [],
        },
      ],
...
describe('Prompt 09 market, offline, and staff routes', () => {
  ...
  it('renders offline routes and staff routes with aliases', async () => {
    ...
    expect(await screen.findByRole('heading', { name: /Offline Analytics/i })).toBeTruthy();
    expect(screen.getByText(/Revenue 30d/i)).toBeTruthy();
